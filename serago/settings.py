...
MIDDLEWARE = [
    ...
    # Serves Django's static files (admin CSS/JS) in production without a
    # separate web server — used by the optional admin dashboard on the VM.
...
# Collected by `manage.py collectstatic` (deploy step); gitignored.
